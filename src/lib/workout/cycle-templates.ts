...
export const CYCLE_TEMPLATES: Array<{
...
}> = [
  {
    id: "four_phase",
    name: "Разгон → сброс",
    hint: "Четыре этапа: разгон, набор, рывок, сброс. После набора можно поднять 1ПМ.",
    cycle: FOUR_PHASE_CYCLE,
  },
  {
    id: "load_deload",
    name: "Нагрузка / разгрузка",
    hint: "После нагрузки можно поднять 1ПМ. Разгрузка лёгкая.",
    cycle: LOAD_DELOAD_CYCLE,
  },
  {
    id: "light_medium_heavy",
    name: "Лёгкая → средняя → тяжёлая",
    hint: "Лёгкая, средняя, тяжёлая. После тяжёлой можно поднять 1ПМ.",
    cycle: LIGHT_MEDIUM_HEAVY_CYCLE,
  },
  {
    id: "light_heavy",
    name: "Лёгкая → тяжёлая",
    hint: "Лёгкая и тяжёлая. После тяжёлой можно поднять 1ПМ.",
  ...
  },
  {
    ...
    hint: "Короткий круг: две недели и сброс. После второй можно поднять 1ПМ.",
    cycle: TWO_WEEK_DELOAD_CYCLE,
  },
  {
    id: "two_week_kg",
    name: "Две недели · +2.5 кг",
    hint: "Две недели по кругу. Рабочий кг растёт на 2.5 после каждой недели.",
  ...
  },
  {
    ...
    hint: "Недели как номера этапов. Свои подходы на каждую неделю — в упражнении дня, там же можно поставить кг.",
