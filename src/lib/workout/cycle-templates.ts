...
export const CYCLE_TEMPLATES: Array<{
...
}> = [
  {
    id: "four_phase",
    name: "Разгон → сброс",
    hint: "Четыре этапа. После набора можно поднять максимум. Сброс лёгкий.",
    cycle: FOUR_PHASE_CYCLE,
  },
  {
    id: "load_deload",
    name: "Нагрузка / разгрузка",
    hint: "После нагрузки можно поднять максимум. Разгрузка — лёгкая неделя.",
    cycle: LOAD_DELOAD_CYCLE,
  },
  {
    id: "light_medium_heavy",
    name: "Лёгкая → средняя → тяжёлая",
    hint: "Три недели: легче, обычно, тяжелее. После тяжёлой можно поднять максимум.",
    cycle: LIGHT_MEDIUM_HEAVY_CYCLE,
  },
  {
    id: "light_heavy",
    name: "Лёгкая → тяжёлая",
    hint: "Две недели: легче и тяжелее. После тяжёлой можно поднять максимум.",
    cycle: LIGHT_HEAVY_CYCLE,
  },
  {
    id: "linear",
    name: "70 → 85% от максимума на раз",
    hint: "Каждая неделя тяжелее: 70, 75, 80, 85% от максимума на раз, потом сброс.",
    cycle: LINEAR_CYCLE,
  },
  {
    id: "volume_strength",
    name: "Объём → сила",
    hint: "Неделя объёма, неделя силы, сброс. После силы можно поднять максимум.",
    cycle: VOLUME_STRENGTH_CYCLE,
  },
  {
    id: "two_week_deload",
    name: "Две недели + сброс",
    hint: "Две рабочие недели и сброс. После второй можно поднять максимум.",
