    ...
    <section className="card-surface flex flex-col gap-3 px-5 py-4">
      <div>
        ...
        <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
          {track && !editing
            ? "Ряд килограммов. Если в цикле стоит прибавка — вес растёт после недели. Если нет — после тренировки."
            : "Ряд килограммов: 80, 82.5, 85… Включается в дне типом «Линейка». Цикл может прибавлять кг после недели."}
        </p>
      </div>
