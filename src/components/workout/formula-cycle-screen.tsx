        ...
        {!loading && formulas ? (
          <>
            <p className="px-1 text-base leading-relaxed text-muted-foreground">
              ...
              максимума на раз или прибавлять рабочие килограммы. Запустить — «Тренировки» →
              ...
              <>
                ...
                <section className="card-surface flex flex-col gap-2 px-5 py-4">
                  ...
                  <p className="text-sm leading-snug text-muted-foreground">
                    {formulas.cycle_loop
                      ? "Прошёл все дни — следующая неделя сама. После последней круг начнётся сначала, и где положена прибавка — рабочий кг вырастет."
                      : formulas.cycle_auto_end
                        ? "Прошёл все дни — этап сменится сам. Где положена прибавка, поднимется максимум или рабочий кг. Последний этап закрывается руками: там новый цикл."
                        : "Прошёл все дни — подскажем, а закроешь этап сам, когда восстановился."}
                  </p>
                </section>
