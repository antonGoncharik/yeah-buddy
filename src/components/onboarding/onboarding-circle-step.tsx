  ...
  return (
    <>
      <p className="animate-rise text-base text-muted-foreground">
        {fromMealPack
          ? "Еда на день возьмётся из ссылки. Сверху — «Всё тело», остальные за «Ещё программы». 1ПМ спросим в зале."
          : "Сверху — «Всё тело». Остальные программы за «Ещё программы». Если у выбранной есть недели — они встанут сами. 1ПМ спросим в зале."}
      </p>
