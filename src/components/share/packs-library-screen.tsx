    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-4 px-4 pb-36">
        <p className="text-base text-muted-foreground">
          Едой на день и программой тренировок делишься отдельными ссылками. В
          ссылку попадают только шаблоны — записи из дневника и рабочие веса
          остаются у тебя. Ссылки от друзей сохраняются сюда, поставить их можно
          когда удобно.
        </p>
