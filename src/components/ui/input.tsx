...
export const nativeSelectClassName =
  "field-control h-12 w-full rounded-xl border border-input/70 bg-input-bg px-2.5 text-base outline-none transition-colors focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50";
