        ...
        {!loading && form ? (
          <section className="card-surface animate-rise flex flex-col gap-3 px-5 py-4">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              Тренировочный день без «Готово» — напомнит, какая тренировка.
              Отдых или закрытый зал и записанная еда — «Yeah buddy». После
              20:00 второе не придёт. Воскресенье — табло за 14 дней с «Как
              прошло».
            </p>
            <Segmented
