...
Сидовые продукты и стартовый состав — `src/lib/seed.ts`. Стартовые продукты сразу в избранном. Имена в сиде с уточнением состояния, например «Овес резаный сухой», «Куриное филе сырое». Сид шаблона пишется только при первом создании; пустой или изменённый шаблон при следующем входе не затирается.
