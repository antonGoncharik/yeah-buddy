...
очередь: готовая программа (один день / сила / всё тело / верх-низ / жим-тяга-ноги) или соберу сам (зал не ведёшь — соберу сам)
...
/settings                           тема и цели БЖУ сверху; «Сохранить» у целей, не липкая. Ниже: продукты, шаблоны еды, история, разбор, очередь, схема подходов, макроцикл, повтор онбординга
...
```text
/workouts                      хаб: очередь, начать зал; фаза — если макро уже есть
/workouts/schedule             очередь: дни в круге, свои не в круге, готовые программы
