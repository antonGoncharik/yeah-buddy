...
Пустые веса можно оставить. Цифра — рабочий вес для схемы подходов, не обязательно максимум на раз. Повтор из Настроек не меняет очередь. Дату прохождения пишет `user_settings.onboarding_completed_at`.
