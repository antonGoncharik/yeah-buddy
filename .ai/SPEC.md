...
- «Как в плане» копирует план в факт по всем подходам (с учётом правок). Подход за подходом не подтверждают.
- после завершения, если факт уехал от плана — виден план; если вес выше плана — ссылка обновить максимум.
...
9. На сессии зала одна кнопка «Как в плане». Можно добавить упражнение и заметку.
