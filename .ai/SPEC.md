...
очередь: ноги / жим / тяга  или  соберу сам (зал не ведёшь — соберу сам)
...
/settings                           тема и цели БЖУ сверху; «Сохранить» у целей, не липкая. Ниже: продукты, шаблоны, история, разбор, схема, макроцикл, повтор онбординга
...
/workouts/schedule             очередь шаблонов (порядок, вкл/выкл), не дни недели
...
Сид пишется только в пустой справочник / пустой круг, уже существующие упражнения и шаблоны не дополняются и не переименовываются. Максимумы не сидятся.

```text
Ноги    динамика   слот a   присед, RDL
Жим     динамика   слот b   жим лёжа, жим стоя
