...
```text
/workouts                      хаб: очередь, начать зал, фаза
...
Макро необязателен. Без него круг работает, схема весов — разгон. На хабе перед «Начать» коротко сказано, что такое макроцикл и откуда сегодняшние веса.
