...
/settings                           цели БЖУ, тема, продукты, шаблоны еды, история еды, разбор, схема подходов, макроцикл, повтор онбординга
...
Правка шаблона не трогает уже созданные дни. Новый день копирует текущий состав. На «Сегодня» после сводки — ссылка на шаблон текущего типа дня.
