...
Экран стола: заметка и «Стол был».
...
9. На сессии зала одна кнопка «сделал как в плане». Можно добавить упражнение и заметку.
