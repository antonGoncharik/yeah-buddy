...
- Your own food list: CRUD, search, favorites, recents. After a food shows up two or three times, the add-food screen offers to favourite it once. A shop catalog can copy a card into that list. An 8–14 digit search looks up the EAN locally, then Open Food Facts, and caches the hit.
